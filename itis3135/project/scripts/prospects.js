// playersByClass object holds all draft prospects (name, position, optional college in future)
...
function filterProspects() {
  ...
  const players = document.querySelectorAll("#prospectList li");
...
function updateProspectList() {
  ...
  filterProspects(); // keep filters active
}
